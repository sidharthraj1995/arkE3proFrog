...
#define STRING_CONFIG_H_AUTHOR "(ArkhamLab, E3pro_skr1.4T_DDE)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Frog"
 ...
 *
 * Temperature sensors available: Z_HOMING_HEIGHT  4      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  15.33 //myFrog HOTEND values - 220C
    #define DEFAULT_Ki   0.98 // Calculate your values
    #define DEFAULT_Kd  59.89 // M303 E0 S220 C10
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 111.35
  #define DEFAULT_bedKi  21.41
  #define DEFAULT_bedKd 386.02
...
#define Z2_DRIVER_TYPE TMC2208  // Frog: To fire up E1 port to be used as Z2
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 421.32 }   // LDO-36STH20-1004AHG Extruder Steps
...
#define INVERT_E7_DIR false Z_HOMING_HEIGHT  4      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 0), (Y_MIN_POS + 0), 1 }
